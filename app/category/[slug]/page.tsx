...
import { CollectionPage, WithContext, BreadcrumbList } from "schema-dts";
...
export default async function CategoryPage(props: CategoryPageProps) {
  ...
  const collectionSchema: WithContext<CollectionPage> = {
    ...
    mainEntity: {
      ...
      itemListElement: posts.map((post, index) => ({
        ...
        author: {
          "@type": "Person",
          name: post.author?.name || "Metalya Team",
        },
      })),
    },
  };
  ...
  return (
    <>
      ...
      <main className="relative min-h-screen flex flex-col pt-8 md:pt-16 overflow-hidden">
