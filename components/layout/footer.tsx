...
export async function Footer() {
  ...
  return (
    <footer className="bg-neutral-950 pt-20 text-neutral-400">
      <Container>
        <div className="grid grid-cols-1 gap-12 border-b border-neutral-800 pb-16 lg:grid-cols-12 lg:gap-8">
          {/* --- Colonne Logo & Social --- */}
          <div className="flex flex-col gap-6 lg:col-span-5">
            <Link
              href="/"
              className="font-serif text-3xl font-medium text-neutral-50"
            >
              Metalya.
            </Link>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-7 lg:pl-10">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="font-medium text-neutral-50">Explorer</h3>
            ...
            {/* Compte (Dynamique) */}
            <div className="flex flex-col gap-4">
              <h3 className="font-medium text-neutral-50">Compte</h3>
              <ul className="flex flex-col gap-3 text-sm">
                {!session ? (
            ...
            {/* Légal */}
            <div className="flex flex-col gap-4">
              <h3 className="font-medium text-neutral-50">Légal</h3>
              <ul className="flex flex-col gap-3 text-sm">
        ...
        <div className="flex flex-col items-center justify-between gap-4 py-8 text-xs sm:flex-row">
          ...
          <p className="flex items-center gap-1">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium text-neutral-200 transition-colors hover:text-white hover:underline"
            >
              {CREATOR.name}
            </a>
          </p>
