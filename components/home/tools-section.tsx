...
const tools = [
  {
    title: "Studio Image",
    description: "Compression & Conversion WebP ultra-rapide et sécurisée.",
    icon: ImageIcon,
  ...
  {
    title: "Nomad Cost",
    description: "Comparateur de coût de la vie pour voyageurs exigeants.",
    icon: Globe,
  ...
  },
  {
    ...
    description: "Ambiances sonores et Pomodoro pour le Deep Work.",
    icon: Clock,
    href: "/outils/focus",
  ...
  {
    title: "SEO Preview",
    description: "Simulateur de SERP Google pour optimiser vos clics.",
    icon: Search,
  ...
  {
    title: "Lecteur Zen",
    description: "Analysez la lisibilité et le temps de lecture de vos textes.",
    icon: Zap,
    href: "/outils/lecture",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <FadeIn>
            ...
            <p className="mt-4 text-lg text-neutral-600 max-w-xl">
              Des utilitaires puissants conçus pour accélérer votre flux de
              travail. Rapides, privés et gratuits.
            </p>
          </FadeIn>
          ...
          <div className="flex gap-6 w-max md:w-full md:grid md:grid-cols-3 lg:grid-cols-5">
            {tools.map((tool, index) => (
              ...
              >
                <Link
                  href={tool.href}
                  className={`group relative flex h-[320px] w-[280px] md:w-auto flex-col justify-between overflow-hidden rounded-3xl bg-white p-6 shadow-sm ring-1 ring-neutral-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${tool.border}`}
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between">
                      <div
                        className={`flex h-12 w-12 items-center justify-center rounded-2xl transition-transform duration-500 group-hover:scale-110 group-hover:bg-white ${tool.bg} ${tool.color}`}
                      >
                        <tool.icon size={24} />
                      </div>
                      <span
