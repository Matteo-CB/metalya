...
import { formatCategory } from "@/lib/utils"; // Assure-toi d'utiliser cette fonction si elle existe
...
export function HeroPost({ post }: HeroPostProps) {
  return (
    <section className="relative mb-24 grid grid-cols-1 gap-8 lg:mb-32 lg:grid-cols-12 lg:gap-16 lg:items-center">
      ...
      <FadeIn className="relative aspect-[4/3] w-full overflow-hidden rounded-3xl shadow-xl shadow-neutral-200/50 md:aspect-[16/9] lg:col-span-8 lg:rounded-[2.5rem] group">
        <Link
          href={`/posts/${post.slug}`}
          className="block h-full w-full overflow-hidden focus:outline-none focus-visible:ring-4 focus-visible:ring-neutral-900/30"
        ...
        >
          ...
          {/* Overlay Gradient Magique amélioré pour lisibilité */}
      ...
      <div className="flex flex-col justify-center lg:col-span-4">
        <FadeIn delay={0.2}>
          <div className="relative space-y-6 md:space-y-8">
            {/* Élément décoratif desktop */}
            <div className="absolute -left-8 top-0 hidden h-full w-px bg-gradient-to-b from-transparent via-neutral-200 to-transparent lg:block" />
            ...
            {/* Titre optimisé pour mobile/desktop */}
